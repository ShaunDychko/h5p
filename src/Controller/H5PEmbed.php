...
class H5PEmbed extends ControllerBase {
  ...
  public function embed($id) {
    ...
    if (empty($h5p_content)) {
      $response['#markup'] = '<body style="margin:0"><div style="background: #fafafa url(' . base_path() . $h5p_module_path . 'assets/h5p-core/images/h5p.svg) no-repeat center;background-size: 50% 50%;width: 100%;height: 100%;"></div><div style="width:100%;position:absolute;top:75%;text-align:center;color:#434343;font-family: Consolas,monaco,monospace">' . t('Content unavailable.') . '</div></body>';
    ...
    ob_start();
    include $h5p_module_path . '/assets/h5p-core/embed.php';
